...
#(raspivid --timeout 30000 --mode 4 --nopreview --output ${dir}/last.h264 && MP4Box -new -add ${dir}/last.h264 ${dir}/last.mp4 && python3 ${dir}/BlobUpload.py ${dir}/last.mp4 >> ${dir}/upload.log 2>&1)&
(raspivid --timeout 30000 --mode 4 --nopreview --output ${dir}/last.h264 && ${dir}/Upload.sh)&
